...
const char *
_cid_log_level_to_string(const GLogLevelFlags loglevel)
{
    switch(loglevel){
...
void 
cid_log_location(const GLogLevelFlags loglevel,
                     const char *file,
                     const char *func,
                     const int line,
                     const char *format,
...
static void 
cid_log_handler(const gchar *log_domain,
...
void 
cid_log_init(gboolean bBlackTerminal)
{
...
void 
cid_log_set_level(GLogLevelFlags loglevel)
{
    gLogLevel = loglevel;
}
